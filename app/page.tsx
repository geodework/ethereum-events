...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cyberpunk-gradient">
      <div className="container py-8">
        <div className="mb-8 text-center">
          <p className="mt-2 text-xl font-extrabold text-neonPink drop-shadow-[0_0_8px_#ff00cc] animate-neonGlow">
      ...
      <Tabs defaultValue="calendar" className="w-full">
        <div className="container py-4">
          <TabsList className="grid w-full max-w-md grid-cols-2 border-2 border-neonPink bg-darkBg shadow-neon">
            <TabsTrigger
              value="calendar"
              className="data-[state=active]:bg-neonPink data-[state=active]:text-neonYellow data-[state=active]:border-neonCyan"
            >
        ...
        <TabsContent value="calendar" className="mt-0 bg-darkBg/80">
          <CalendarView events={filteredEvents} />
        </TabsContent>

        <TabsContent value="list" className="mt-0 bg-darkBg/80">
