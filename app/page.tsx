...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary flex flex-col items-center">
      <div className="w-full py-12 flex justify-center">
        <h1 className="cyberpunk-heading text-3xl md:text-4xl text-center drop-shadow-cyberpunk-glow">
      ...
      <Tabs defaultValue="calendar" className="w-full">
        <div className="container py-4">
          <TabsList className="grid w-full max-w-md grid-cols-2 border bg-white">
            <TabsTrigger
              value="calendar"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary/10 data-[state=active]:to-green-400/10 data-[state=active]:text-primary"
            >
