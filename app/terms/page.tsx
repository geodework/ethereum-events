    ...
    <div className="container max-w-4xl py-12 px-4 md:px-8 lg:px-12 rounded-xl shadow-lg mt-8 mb-16">
      ...
      <div className="max-w-3xl space-y-6 text-secondary-700">
        ...
        <p>
          ...
          to your use of https://ethereumjobboard.com/ (the &quot;Website&quot;)
          as a user (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;). By
          using the Website, you agree that you have read, understood and accept
          all the terms and conditions contained in this Agreement as well as
          our Privacy Policy, and you acknowledge and agree that you will be
          bound by them. Section 9 of this Agreement governs how this Agreement
          may be changed over time.
        </p>

        <h2 className="text-2xl font-semibold text-primary mt-8">
          Access to and Changes to Our Website
        </h2>
        <p>
        ...
        <p>
          The Website enables employers to post job openings and allows users
          visiting the Website to apply for open jobs. The Company does not take
          any responsibility or liability for any of the postings. If you think
          that any posting is fraudulent, inappropriate, or otherwise violates a
          relevant law, please contact us at{" "}
          <a
            href="mailto:ethereumjobs@geodework.com"
            className="text-primary underline"
          >
            ethereumjobs@geodework.com
          </a>
          . If you are an employer who makes a posting, you hereby represent
          that all relevant laws related to the job have been followed and you
          hereby agree to indemnify the Company for any job posting that results
          in loss to the Company as a result of a violation of a relevant law.
        </p>
        ...
        <p>
          ...
          information. The Website may also contain links to third-party
        ...
        <p>
          ...
          to ask any questions regarding this Agreement or the Website.
        </p>
      </div>
    </div>
  )
